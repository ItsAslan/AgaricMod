...
import itsaslan.agaric.blocks.fungi.*;
...
public class ModBlocks
{
    ...
    public static void BlockInit()
    {
        ...
        brownFungiBlock = new BrownFungiBlock(Material.rock).setBlockName("brownFungiBlock").setCreativeTab(CreativeTabs.tabBlock).setStepSound(soundTypeCloth);
        redFungiBlock = new RedFungiBlock(Material.rock).setBlockName("redFungiBlock").setCreativeTab(CreativeTabs.tabBlock).setStepSound(soundTypeCloth);
    }
